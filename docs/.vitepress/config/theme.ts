...
export const themeConfig: DefaultTheme.Config = {
  ...
  // 编辑链接配置
  editLink: {
    pattern: 'https://github.com/steady298/steady298.GitHub.io/edit/main/repos/:path',
    text: '不妥之处，敬请雅正'
  },
  // 全文搜索配置
  algolia: {
  ...
  // 导航栏右侧社交链接配置
  socialLinks: [
    { icon: 'github', link: 'https://github.com/steady298/steady298.GitHub.io' },
    {
      icon: {
    ...
    {
      icon: {
        svg: '<svg role="img" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><title>github链接</title><path d="M512 22C241.38 22 22 241.38 22 512s219.38 490 490 490 490-219.38 490-490S782.62 22 512 22z m226.06 277.73L517.54 809.14c-3.18 7.28-13.72 7.08-17.21-0.41L410.4 616.57a5.966 5.966 0 0 0-2.97-2.97L215.6 523.58c-7.58-3.49-7.79-14.05-0.41-17.23l508.74-220.76c8.91-3.91 18.03 5.22 14.13 14.14z" p-id="4967"></path></svg>'
      },
      link: 'https://github.com/steady298/steady298.GitHub.io'
    }
  ],

  // 自定义扩展: 文章元数据配置
  articleMetadataConfig: {
    author: 'Coolman', // 文章全局默认作者名称
